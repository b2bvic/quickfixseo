...
export const metadata: Metadata = {
  title: 'Company',
  description:
    'We&apos;re on a mission to transform SEO workflows by delivering professional audits in minutes, not weeks. Learn about AUTO SEO&apos;s story and team.',
}

function Header() {
  return (
    <Container className="mt-16">
      <Heading as="h1">Transforming SEO workflows worldwide.</Heading>
      <Lead className="mt-6 max-w-3xl">
        We&apos;re on a mission to save agencies thousands of hours by automating professional SEO audits. 
      ...
      <section className="mt-16 grid grid-cols-1 lg:grid-cols-2 lg:gap-12">
        <div className="max-w-lg">
          ...
          <p className="mt-6 text-sm/6 text-gray-600">
            At AUTO SEO, we are dedicated to transforming the way agencies and consultants 
            deliver SEO audits. Our mission is to provide our customers with professional, 
            comprehensive audits in minutes instead of weeks, giving them more time to focus 
            on strategy and client relationships.
          </p>
          <p className="mt-8 text-sm/6 text-gray-600">
            We&apos;re customer-obsessed — building tools that save real time and deliver real value. 
            Our automated auditing platform has helped over 2,800 agencies streamline their workflows, 
            close more deals, and scale their businesses without hiring additional staff.
          </p>
        </div>
        ...
        <div className="max-lg:mt-16 lg:col-span-1">
          ...
          <dl className="mt-6 grid grid-cols-1 gap-x-8 gap-y-4 sm:grid-cols-2">
            <div className="flex flex-col gap-y-2 border-b border-dotted border-gray-200 pb-4">
              <dt className="text-sm/6 text-gray-600">Agencies Served</dt>
              <dd className="order-first text-6xl font-medium tracking-tight">
                <AnimatedNumber start={2000} end={2800} />+
              </dd>
            </div>
            <div className="flex flex-col gap-y-2 border-b border-dotted border-gray-200 pb-4">
              <dt className="text-sm/6 text-gray-600">Pages Audited</dt>
              <dd className="order-first text-6xl font-medium tracking-tight">
                <AnimatedNumber start={10} end={15} />M
              </dd>
            </div>
            <div className="flex flex-col gap-y-2 max-sm:border-b max-sm:border-dotted max-sm:border-gray-200 max-sm:pb-4">
              <dt className="text-sm/6 text-gray-600">Hours Saved</dt>
              <dd className="order-first text-6xl font-medium tracking-tight">
                <AnimatedNumber start={100} end={150} />K
              </dd>
            </div>
            <div className="flex flex-col gap-y-2">
              <dt className="text-sm/6 text-gray-600">Client Reports</dt>
              <dd className="order-first text-6xl font-medium tracking-tight">
                <AnimatedNumber start={50} end={75} />K
              </dd>
            </div>
          </dl>
        </div>
...
function Team() {
  return (
    <Container className="mt-32">
      ...
      <Lead className="mt-6 max-w-3xl">
        AUTO SEO is founded by two of the best sellers in the business and backed
        by investors who look the other way.
      </Lead>
      <div className="mt-12 grid grid-cols-1 gap-12 lg:grid-cols-2">
        <div className="max-w-lg">
          <p className="text-sm/6 text-gray-600">
            Years ago, while working as SEO consultants at different agencies,
            our founders were frustrated by the time-consuming nature of manual audits.
            They spent weeks gathering data, checking meta tags, and creating reports
            that clients needed immediately. They had an idea: what if they could
            automate the entire process while maintaining professional quality?
            That idea became the foundation for AUTO SEO.
          </p>
          <p className="mt-8 text-sm/6 text-gray-600">
            Today, AUTO SEO transforms how agencies deliver SEO audits by automating
            the entire process from crawling to reporting. More than 2,800 agencies
            rely on AUTO SEO to deliver professional audits in minutes instead of weeks,
            allowing them to scale their services and focus on strategy.
          </p>
          <div className="mt-6">
      ...
      <figure className="relative p-10">
        <blockquote>
          <p className="relative text-xl/7 text-white">
            &ldquo;AUTO SEO has completely transformed our workflow. We can now deliver 
            professional audits in minutes instead of weeks.&rdquo;
          </p>
        </blockquote>
